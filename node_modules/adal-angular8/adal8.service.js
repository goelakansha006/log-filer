...
var Adal8Service = /** @class */ (function () {
     ...
     * @memberOf Adal8Service
     */
    Adal8Service.prototype.handleWindowCallback = function () {
    ...
    Adal8Service.prototype.acquireToken = function (resource) {
        ...
        var errorMessage;
        return bindCallback_1.bindCallback(acquireTokenInternal, function (token) {
     ...
     * @memberOf Adal8Service
     */
    Adal8Service.prototype.updateDataFromCache = function (resource) {
    ...
    Adal8Service.prototype.refreshLoginToken = function () {
        ...
        this.acquireToken(this.adalContext.config.loginResource).subscribe(function (token) {
            ...
            if (_this_1.adal8User.authenticated == false) {
                _this_1.adal8User.authenticated = true;
                _this_1.adal8User.error = '';
            ...
            _this_1.adal8User.authenticated = false;
            _this_1.adal8User.error = _this_1.adalContext.getLoginError();
        });
    };
    ...
    Adal8Service.prototype.setupLoginTokenRefreshTimer = function () {
        ...
        this.loginRefreshTimer = timer_1.timer(timerDelay * 1000).subscribe(function (x) {
